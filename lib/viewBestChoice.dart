...
class ViewBestChoice extends StatefulWidget {
  const ViewBestChoice({super.key});

  @override
  State<ViewBestChoice> createState() => _ViewBestChoiceState();
}

class _ViewBestChoiceState extends State<ViewBestChoice> {
  late Color myColor;
  late Size mediaSize;
